    ...
    public async Task<IReadOnlyList<TowerConnectedDeviceDto>> GetConnectedDevicesForTowerAsync(string cellId, CancellationToken cancellationToken = default)
    {
        ...
        if (devices.Count < 20)
        {
            ...
            var sampleSubscribers = new (string Name, string Model, string Type, string Plat, string Band, string Phone, string Modulation, double Throughput)[]
            {
                ...
                ("Google Pixel 9 Pro (Field Node)", "GC3VE 5G", "Mobile Collector", "Android 15", "Band n78 (3500 MHz)", "+91 98901 44210", "256-QAM", 240.5),
                ...
                ("Samsung Galaxy S24+", "SM-S926B 5G", "Smartphone (5G UE)", "Android 14", "Band 3 (1800 MHz)", "+91 98500 12345", "64-QAM", 130.0),
